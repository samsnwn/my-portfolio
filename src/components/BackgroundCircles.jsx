...
const BackgroundCircles = () => {
  return (
    <motion.div className='relative top-[60%] md:top-0 flex justify-center items-center' initial={{opacity:0 }} animate={{scale:[1,2,2,3,1], rotate:360,opacity:[0.1, 0.2, 0.4, 0.8, 0.1, 1.0]}} transition={{duration:2.5}}>
