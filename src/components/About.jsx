...
const About = () => {
  return (
    ...
    >
      <h3
        className={`absolute top-4 md:top-[15%] uppercase tracking-[20px] ${styles.textColor500} text-2xl`}
      >
        About
      </h3>
      ...
      <motion.img
        ...
        view={{ once: true }}
        className="md:mb-0 flex-shrink-0 w-56 h-56 rounded-full object-cover md:rounded-lg md:w-64 md:h-96 xl:h-[600px]"
      />
